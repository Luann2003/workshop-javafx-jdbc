...
public class SellerFormController implements Initializable {
	...
	private List<DataChangeListener> dataListeners = new ArrayList<>();
	...
	@FXML
	private Label labelErrorBaseSlary;
	...
	public void setServices(SellerService service, DepartmentService DEservice) {
		this.service = service;
		this.departmentService = DEservice;
	}
	...
	private void notifyDataChangeListeners() {
		for (DataChangeListener listener : dataListeners) {
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		labelErrorBaseSlary.setText((fields.contains("baseSalary") ? errors.get("baseSalary") : ""));
	}
